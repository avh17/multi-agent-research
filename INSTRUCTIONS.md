...
2. **Dependencies:** Include a setup cell installing `openai-agents`, `python-dotenv`, `pydantic`, `requests`.
3. **Modularity:**
...
- Keep the Researcher creation isolated so it can later be swapped for a different domain-specific researcher.
